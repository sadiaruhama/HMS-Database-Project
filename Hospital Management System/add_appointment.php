...
<body> 
    ...
    <section id="section1" class="container">
        <div class="title"> Add a new Appointment </div>
        
        <form id="appointmentForm" action="show_appointment.php" class="form_design" method="post">
            Appointment_ID: <input type="text" name="did"> <br>
            Doctor_Name: <input type="text" name="name"> <br> 
            Date: <input type="text" name="date"> <br>
            Time: <input type="text" name="time" id="timeInput"> <br> <!-- Changed name to 'time' and added id for JavaScript access -->
            <br>
